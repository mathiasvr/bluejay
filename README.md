...
- Temperature throttle limit & notification
	...
	- Notify Betaflight 0 rpm when temperature limit is reached. Note. Activate OSD Motor Diagnostics in Betaflight to see in OSD when temperature limit is being applied.
